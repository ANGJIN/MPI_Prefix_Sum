...
int main(int argc, char *argv[]) {
    ...
    MPI_Iscatterv(sendBuf, cnt, disp, MPI_INT, prefixSum, n_local, MPI_INT, 0, MPI_COMM_WORLD, &req);
    MPI_Wait(&req,&stat);
    ...
    MPI_Iscan(&localSum, &recvBuf, 1, MPI_INT, MPI_SUM, MPI_COMM_WORLD, &req);
    MPI_Wait(&req,&stat);
    ...
    MPI_Igatherv(prefixSum, n_local, MPI_INT, sendBuf, cnt, disp, MPI_INT, 0, MPI_COMM_WORLD, &req);
    MPI_Wait(&req,&stat);
